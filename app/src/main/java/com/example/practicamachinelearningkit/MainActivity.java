package com.example.practicamachinelearningkit;
        ...
        implements OnSuccessListener<Text>, OnFailureListener, ImageAnalysis.Analyzer
{
    ...
    @Override
    public void analyze(@NonNull View v) {
        InputImage image = InputImage.fromBitmap(mSelectedImage, 0);
        ObjectDetectorOptions options = new ObjectDetectorOptions()
                .getDetectorMode(ObjectDetectorOptions.DEFAULT_OPTIONS);
    }*/
